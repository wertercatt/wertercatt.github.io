...
let blogName = "wertercatt's hacking notes";
let authorName = "wertercatt";
let authorLink = "https://wertercatt.com"; // Enter your website, social media, etc. Some way for people to tell you they like your blog! (Leaving it empty is okay too)
...
let postsArray = [
    ...
    ["posts/2022-04-03-Degen-Islands-Demo.html"]
];
...
let footerHTML = "<hr><p>" + blogName + " is written by <a href='" + authorLink + "'>" + authorName + "</a>, built with <a href='https://zonelets.net/'>Zonelets</a>, and hosted on a <a href='https://archlinux.org/'>Arch Linux home server!</a></p>";
